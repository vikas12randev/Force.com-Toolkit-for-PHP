...
namespace WebFonts
{
    public class FontAwesome
    {
        ...
        private static string _downloadLink = "fonts/fontawesome-webfont.ttf";
        ...
        private Font GetIconFont(int pixelSize)
        {
            if(pixelSize > 0)
            {
                float size = pixelSize / (16f / 12f); //pixel to point conversion rate
                                                    //maybe caching would be useful
                Font font = new Font(_fonts.Families[0], size, FontStyle.Regular, GraphicsUnit.Point);
                return font;
            }
            return null;
        }
